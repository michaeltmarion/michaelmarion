/*
 ...
 MyFonts Webfont Build ID 3392454, 2017-05-20T18:34:17-0400
 ...
 License: https://www.myfonts.com/viewlicense?type=web&buildid=3392454
...
for(var fonts=[{fontFamily:"FrutigerLTPro-Bold",url:wfpath+"33C3C6_0"+suffix+"_0."+webfontType},{fontFamily:"FrutigerLTPro-Roman",url:wfpath+"33C3C6_1"+suffix+"_0."+webfontType},{fontFamily:"FrutigerLTPro-Light",url:wfpath+"33C3C6_2"+suffix+"_0."+webfontType},{fontFamily:"FrutigerLTPro-Italic",url:wfpath+"33C3C6_3"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+
